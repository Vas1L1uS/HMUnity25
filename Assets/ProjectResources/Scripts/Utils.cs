...
public static class Utils
{
    ...
    private static float3 Abs(float3 vector)
    {
        return new float3(Mathf.Abs(vector.x), Mathf.Abs(vector.y), Mathf.Abs(vector.z));
    }

    private static float Max(float3 vector)
    {
